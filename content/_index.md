...
I'm an AI Research Engineer at [Helsing](https://helsing.ai/), where I build AI safeguard systems and evaluation infrastructure for real-world deployment. My work spans end-to-end development of safety models, scalable workflows for performance and safety evaluation, and edge deployment of conformal prediction and confidence calibration methods. My core expertise sits at the intersection of AI safety and evaluation: conformal prediction, confidence calibration, uncertainty quantification, out-of-distribution detection, robustness testing, and experimental design.
